...
public abstract class ExclusionFilterGlass extends Block {
  public ExclusionFilterGlass(Properties properties) {
    super(properties);
  }

  protected abstract boolean blocksCobblemon(PokemonEntity entity);
  ...
  protected VoxelShape getCollisionShape(
    ...
    if (context instanceof EntityCollisionContext entityContext) {
      ...
      if (entity instanceof PokemonEntity pokemon) {
        return blocksCobblemon(pokemon) ? Shapes.block() : Shapes.empty();
      }
      if (entity != null) {
        return Shapes.empty();
      }
